...
// var refillMutation_p  = 90.0 // probability
// var mutation_m        = 0.1
// var mutation_p        = 1.0
...
function ControlPanel(){
  ...
  this.SLIDERS[10]     = createSlider(0, 0.1, DNAmutationProb, 0.0001)
  this.SLIDERTEXTS[11] = "Refill barrier"
  this.SLIDERS[11]     = createSlider(0, 1000, boidRefillBarrier, 1)
  ...
  this.assignPositions = function(x0,y0,Dx,Dy){
  ...
  this.display = function(x0,y0,Dx,Dy){
    noStroke();
    fill(0);
    for(var i=0; i<this.SLIDERS.length; i++){
